    ...
    <div class="section-frame">
      <div class="glass-panel highlight callout-panel relative overflow-hidden px-8 py-12 md:px-12">
        ...
        <div class="space-y-4">
          ...
          <h3 class="headline-effect text-3xl font-semibold md:text-4xl">{{ t('callout.title') }}</h3>
          <p class="text-sm body-copy">{{ t('callout.description') }}</p>
        </div>
        <div class="flex flex-col gap-4">
          <NuxtLink :to="localePath('/contact')" class="cta-button justify-center">
            {{ t('callout.primaryCta') }}
          </NuxtLink>
          <NuxtLink :to="localePath('/case-studies')" class="ghost-button justify-center">
