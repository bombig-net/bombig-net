<template>
  <div class="space-y-24 pb-24">
    <section class="relative overflow-hidden">
      <div class="absolute -left-24 top-16 h-72 w-72 rounded-full bg-amber-300/20 blur-3xl" />
      <div class="absolute right-0 top-32 h-72 w-72 rounded-full bg-emerald-300/20 blur-3xl" />
      <div class="section-shell relative grid gap-12 pb-16 pt-28 md:grid-cols-[1.1fr_0.9fr]">
        <div class="space-y-8">
          ...
          <p class="max-w-xl text-base text-slate-300">{{ t('servicePages.smbFlatFee.hero.description') }}</p>
        ...
        <div class="glass-panel space-y-6 p-8">
          ...
          <p class="text-sm text-slate-300">{{ t('servicePages.smbFlatFee.hero.priceNote') }}</p>
    ...
    <section class="section-shell space-y-10">
      ...
      <div class="grid gap-6 md:grid-cols-3">
        <div class="glass-panel p-6">
          ...
          <p class="mt-3 text-sm text-slate-300">{{ t('servicePages.smbFlatFee.included.items.first.text') }}</p>
        </div>
        <div class="glass-panel p-6">
          ...
          <p class="mt-3 text-sm text-slate-300">{{ t('servicePages.smbFlatFee.included.items.second.text') }}</p>
        </div>
        <div class="glass-panel p-6">
          ...
          <p class="mt-3 text-sm text-slate-300">{{ t('servicePages.smbFlatFee.included.items.third.text') }}</p>
        </div>
      </div>
    </section>
    ...
    <section class="section-shell grid gap-10 md:grid-cols-[1.1fr_0.9fr]">
      ...
      <div class="space-y-4">
        <details class="glass-panel p-6">
          ...
          <p class="mt-3 text-sm text-slate-300">{{ t('servicePages.smbFlatFee.faq.items.first.answer') }}</p>
        </details>
        <details class="glass-panel p-6">
          <summary class="cursor-pointer text-sm font-semibold">{{ t('servicePages.smbFlatFee.faq.items.second.question') }}</summary>
          <p class="mt-3 text-sm text-slate-300">{{ t('servicePages.smbFlatFee.faq.items.second.answer') }}</p>
        </details>
        <details class="glass-panel p-6">
          <summary class="cursor-pointer text-sm font-semibold">{{ t('servicePages.smbFlatFee.faq.items.third.question') }}</summary>
          <p class="mt-3 text-sm text-slate-300">{{ t('servicePages.smbFlatFee.faq.items.third.answer') }}</p>
        </details>
      </div>
    </section>
    ...
    <section class="section-shell">
      <div class="glass-panel flex flex-col gap-6 p-10 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p class="mt-3 text-sm text-slate-300">{{ t('servicePages.smbFlatFee.finalCta.description') }}</p>
        </div>
